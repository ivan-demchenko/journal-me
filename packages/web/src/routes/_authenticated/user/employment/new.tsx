import type { NewEmploymentPayload } from "@jm/server/shared";
          ...
          <div className="flex-1">
            ...
            <input
              ...
              onChange={(e) =>
                setForm((prev) => ({
                  ...prev,
                  started: new Date(e.target.value),
                }))
              }
              className="form-field-textarea"
              id="started"
            ...
            <label>
              <input
                type="checkbox"
                checked={form.ended === null}
                onChange={handleStillAtTheCompanyStatus}
              />
              I still work here
            </label>
          </div>
